...
import (
	...
	"github.com/averyboy/protobuf/protoc-gen-go/generator/internal/remap"

	"github.com/averyboy/protobuf/protoc-gen-go/descriptor"
	plugin "github.com/averyboy/protobuf/protoc-gen-go/plugin"
)

func init() {
	fmt.Fprint(os.Stderr,
		"WARNING: Package \"github.com/averyboy/protobuf/protoc-gen-go/generator\" is deprecated.\n"+
...
func (g *Generator) generateImports() {
	...
	g.P(g.Pkg["fmt"] + ` "fmt"`)
	g.P(g.Pkg["math"] + ` "math"`)
	g.P(g.Pkg["proto"]+" ", GoImportPath(g.ImportPrefix)+"github.com/averyboy/protobuf/proto")
